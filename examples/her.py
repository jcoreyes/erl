...
I know it says "TDM" somtimes. I coded up TDM so that HER is a specific
configuration of TDMs.
"""
...
from railrl.state_distance.her import HerQFunction, HerPolicy, HER
