...
gdcrl = get_trials(
    ...
    # osp.join(base_path, 'pb-4obj/07-18-distr-inferred-n-30'),

    # osp.join(base_path, 'pb-4obj/07-21-distr-use-proper-mean-inferred-n-30'),
)
gcrl = get_trials(
    osp.join(base_path, 'pb-4obj/07-19-point'),
)
