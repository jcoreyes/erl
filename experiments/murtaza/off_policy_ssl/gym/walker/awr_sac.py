...
if __name__ == "__main__":
    ...
    search_space = {
        ...
        'path_loader_kwargs.demo_off_policy_path':[
            # 'demos/walker_off_policy_10_demos_100.npy',
            'demos/walker_off_policy_15_demos_100.npy',
            # 'demos/walker_off_policy_25_demos_100.npy',
        ],
    ...
    n_seeds = 4
    mode = 'ec2'
    exp_prefix = 'awr_sac_walker_offline_online_v1'
