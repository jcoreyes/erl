...
from experiments.steven.goal_generation.pickup_goal_dataset import \
        generate_vae_dataset, setup_pickup_image_env
...
if __name__ == "__main__":
    ...
    variant = dict(
        ...
        init_camera=[sawyer_pick_and_place_camera, sawyer_pick_and_place_camera_slanted_angle],
        grill_variant=dict(
            ...
            generate_goal_dataset_fn=setup_pickup_image_env,
            ...
            replay_kwargs=dict(
                ...
                # exploration_rewards_scale=1000.0,
    ...
    n_seeds = 2
    mode = 'ec2'
    exp_prefix = 'multicam-test-fixed-action-scale'
