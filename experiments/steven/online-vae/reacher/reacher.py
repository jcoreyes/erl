...
#        env_class=SawyerPickAndPlaceEnv,
        ...
        grill_variant=dict(
            vae_path="07-03-multi-exp-single-instance-multiworld-2/07-03-multi-exp-single-instance-multiworld-2_2018_07_03_00_44_16_0000--s-29282/vae.pkl",
            algo_kwargs=dict(
                num_epochs=100,
        ...
        train_vae_variant=dict(
            ...
            algo_kwargs=dict( do_scatterplot=False,
                lr=1e-3,
            ),
            save_period=5,
        ),
    ...
    n_seeds = 1
    mode = 'local'
    exp_prefix = 'multi-exp-single-instance-multiworld-2'
