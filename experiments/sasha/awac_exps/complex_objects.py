...
if __name__ == "__main__":
    variant = dict(
        ...
        #pretrained_vae_path="sasha/complex_objects/vae.pkl",
        presampled_goals_path="/home/ashvin/data/sasha/demos/zero_goals.pkl",

        pretrained_vae_path="/home/ashvin/data/sasha/cvqvae/vqvae/run21/id0/vae.pkl",
        #presampled_goals_path="/home/ashvin/data/rail-khazatsky/sasha/simple_obj/zero_goals.pkl",
        ...
        path_loader_kwargs=dict(
            ...
            demo_paths=[
                dict(
                    path='/home/ashvin/data/sasha/demo/4dof_complex_objects_demos_0.pkl',
                    obs_dict=True,
                    is_demo=True,
                    data_split=0.01,
                ),
                dict(
                    path='/home/ashvin/data/sasha/demo/4dof_complex_objects_demos_1.pkl',
                    obs_dict=True,
                    is_demo=True,
                    data_split=0.01,
                ),
                dict(
                    path='/home/ashvin/data/sasha/demo/4dof_complex_objects_demos_2.pkl',
                    obs_dict=True,
                    is_demo=True,
                    data_split=0.01,
                ),
                dict(
                    path='/home/ashvin/data/sasha/demo/4dof_complex_objects_demos_3.pkl',
                    obs_dict=True,
                    is_demo=True,
                    data_split=0.01,
                ),
                dict(
                    path='/home/ashvin/data/sasha/demo/4dof_complex_objects_demos_4.pkl',
                    obs_dict=True,
                    is_demo=True,
                    data_split=0.01,
                ),
