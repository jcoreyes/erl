...
from railrl.torch.networks import (
    FlattenMlp, MergedCNN, PretrainedCNN,
...
def experiment(variant):
    ...
    if variant['shared_qf_conv']:
        qf_cnn = PretrainedCNN(torchvision_architecture=models.resnet18, **cnn_params)
        ...
        target_qf_cnn = PretrainedCNN(torchvision_architecture=models.resnet18, **cnn_params)
        ...
        qf1_cnn = PretrainedCNN(torchvision_architecture=models.resnet18, **cnn_params)
        ...
        qf2 = MlpQfWithObsProcessor(
            obs_processor=PretrainedCNN(torchvision_architecture=models.resnet18, **cnn_params),
            output_size=1,
            input_size=action_dim+cnn_output_dim,
            **variant['qf_kwargs']
        )
    ...
    action_dim = int(np.prod(env.action_space.shape))
    policy_cnn = PretrainedCNN(torchvision_architecture=models.resnet18, **cnn_params)
...
if __name__ == "__main__":
    ...
    n_seeds = 3
    # mode = 'ec2'
    exp_prefix = 'online-match-hps-point2d-32x32-img-all-fc-goal00-resnet18'
