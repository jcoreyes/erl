...
dirs = [
        '/home/ashvin/data/s3doodad/ashvin/vae/fixed3/pusher2d/state-both/run0/id13',
        '/home/ashvin/data/s3doodad/ashvin/vae/fixed3/pusher2d/state-both/run0/id15',
        '/home/ashvin/data/s3doodad/ashvin/vae/fixed3/pusher2d/state-both/run0/id17',
        '/home/ashvin/data/s3doodad/ashvin/vae/fixed3/pusher2d/vae-dense/run0/id74',
       ]
f = plot.filter_by_flat_params({'n_batches': 1024})
exps = plot.load_exps(dirs, f, suppress_output=False)
plot.split(exps, ["Final dist Mean"],
           ["do_state_based_exp"],
