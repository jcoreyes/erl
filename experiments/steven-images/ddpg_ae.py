...
from railrl.torch.networks import FeatPointMlp, Autoencoder
...
def experiment(variant):
    latent_size = 32
    history = 3
    latent_obs_dim = latent_size * history
    imsize = 32
    downsampled_size = 16
...
#                                init_camera=camera.sawyer_init_camera)
    ...
    ae = Autoencoder(
        input_length=imsize**2,
        output_length=downsampled_size**2,
        latent_length=latent_size
    )
