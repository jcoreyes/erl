...
if __name__ == '__main__':
    ...
    #     normalize=True,
    # )
    collect_demos_fixed(env, policy, "/home/ashvin/data/s3doodad/demos/icml2020/mujoco/pendulum.npy", N=100, horizon=50) # , threshold=.1, add_action_noise=False, key='puck_distance', render=True, noise_sigma=0.0)
