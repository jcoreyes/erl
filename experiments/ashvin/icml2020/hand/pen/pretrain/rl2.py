...
if __name__ == "__main__":
    ...
    search_space = {
        ...
        'trainer_kwargs.post_pretrain_hyperparams.rl_weight': [0.00001, ],
        'trainer_kwargs.post_pretrain_hyperparams.bc_weight': [0.0, ],
        'trainer_kwargs.post_pretrain_hyperparams.awr_weight': [1000.0, ],
