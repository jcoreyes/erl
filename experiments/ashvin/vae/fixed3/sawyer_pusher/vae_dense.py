from railrl.envs.mujoco.sawyer_push_and_reach_env import SawyerPushAndReachXYEnv,SawyerPushAndReachXYEasyEnv
...
if __name__ == "__main__":
    vae_paths = {
        "32": "ashvin/vae/fixed3/sawyer-pusher/train-vae/run0/id3/itr_480.pkl",
    }
