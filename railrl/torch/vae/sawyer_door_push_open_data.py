...
from multiworld.envs.mujoco.sawyer_xyz.sawyer_door import SawyerDoorPushOpenEnv, SawyerDoorPushOpenActionLimitedEnv
from multiworld.core.image_env import ImageEnv
from railrl.exploration_strategies.base import PolicyWrappedWithExplorationStrategy
from railrl.exploration_strategies.ou_strategy import OUStrategy
from railrl.images.camera import sawyer_door_env_camera, sawyer_door_env_camera_closer
import cv2
...
def generate_vae_dataset(
        ...
        action_plus_random_sampling=False, init_camera=sawyer_door_env_camera_closer,
):
    ...
    if dataset_path is not None:
        ...
        env = SawyerDoorPushOpenActionLimitedEnv(**env_kwargs)
        env = ImageEnv(
            env, imsize,
            transpose=False,
