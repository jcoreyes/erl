...
def generate_vae_dataset(
        ...
        dataset_path=None, policy_path=None, action_space_sampling=False, env_class=SawyerDoorPullOpenActionLimitedEnv, env_kwargs=None,
        action_plus_random_sampling=False, init_camera=sawyer_door_env_camera_closer, ratio_action_sample_to_random=1/2,
):
    ...
    if dataset_path is not None:
        ...
        action_space = Box(
            np.array([-env.max_x_pos, env.min_y_pos, .06]),
