...
class HerSac(SoftActorCritic):
    """
    TODO: This is basically a copy/paste of HerTd3.
    It MAY be worth avoiding this duplicate
    """
    def __init__(
            self,
            *args,
    ...
    def eval_multitask_rollout(self):
        ...
        while path_length < self.max_path_length:
            ...
            a, agent_info = self.policy.get_action(new_obs, deterministic=True)
