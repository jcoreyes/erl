"""This is in the old policy format. TODO: update to new format

An issue is that the policy needs to output multiple things: the action
distribution and the latent distribution.
"""
