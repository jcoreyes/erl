...
class DCGANTrainer(LossFunction):

    def __init__(self, model, ngpu, lr, beta1, nc, nz, ngf, ndf):
    ...
    def train_epoch(self, dataloader, epoch):
        for i, data in enumerate(dataloader, 0):
            ...
            G_losses[iters] = errG.item()
            D_losses[iters] = errD.item()
